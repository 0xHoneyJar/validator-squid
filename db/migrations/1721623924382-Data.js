module.exports = class Data1721623924382 {
    name = 'Data1721623924382'

    async up(db) {
        await db.query(`CREATE TABLE "quest_step" ("id" character varying NOT NULL, "step_number" integer NOT NULL, "type" text NOT NULL, "address" text NOT NULL, "token_id" numeric, "event_name" text NOT NULL, "filter_criteria" jsonb, "required_amount" integer NOT NULL, "progress_amount" integer NOT NULL, "quest_id" character varying, CONSTRAINT "PK_2701eac9024314902255b9efaf7" PRIMARY KEY ("id"))`)
